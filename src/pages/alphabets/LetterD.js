...
import { QuestionD } from "../../components/QuestionBox";
...
const LetterD = () => {
  ...
  const handleClick = (isCorrect) => {
    ...
    if (nextQuestion < QuestionD.length) {
    ...
    <>
      <div className="demo-con alphabet-con">
        ...
        <div className="practice-con">
          ...
          <div className="practice-wrap">
            <h3>
              <span className="read-eng">D</span>oor
            </h3>
            <h3 className="read-kor">
              도 <span className="otherletters"> 어</span>
          ...
          <div className="practice-wrap">
            <h3>
              <span className="read-eng">D</span>ream
            </h3>
            <h3 className="read-kor">
              <span className="otherletters"> 드</span> 림
        ...
        <div className="letter-test-con objective">
          {showScore ? (
            <section className="showScore-section">
              {QuestionD.length}개 중에서 {score}개나 맞추셨네요!
            </section>
          ) : (
            <>
              <section className="question-section">
                <h1 style={{ marginLeft: "auto" }}>
                  문제 {currentQuestion + 1}/{QuestionD.length}
                </h1>
                <p>{QuestionD[currentQuestion].questionText}d</p>
              </section>

              <section className="answer-section">
                {QuestionD[currentQuestion].answerOption.map((i) => (
